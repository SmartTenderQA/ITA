...
Видалити документ та закрити браузер
    Run Keyword And Ignore Error  Видалити документ
    Close All Browsers


Видалити документ
    Перезагрузка сторінки та повернення в Конструктор бизнес-процессов и потоков документов
...
Обрати доданий документ
    Wait Until Keyword Succeeds  15  2  Click Element  //tr[contains(@class, "Row")]//td[text()="${object}"]
    Sleep  1
